...
type _ItemValue = Chord | Note | Rest | Overlapped | Sequence | Mode | Scale | Set
...
class Item:
    ...
    @property
    def value(self) -> _ItemValue: ...

    @value.setter
    def value(self, value: _ItemValue) -> None: ...
...
class Overlapped:
    def __new__(
        cls: type,
        sections: abc.Sequence[Item | _ItemValue] | None = None,
        state_member: StateMember | None = None,
    ): ...
    @staticmethod
    ...
    def __setitem__(self, index: int, value: Item | _ItemValue | abc.Sequence[Item | _ItemValue]): ...
    def __delitem__(self, index: int): ...
    def __iter__(self) -> _OverlappedIterator: ...
    def insert(self, index: int, value: Item | _ItemValue): ...
    def pop(self, index: int | None = None) -> Item: ...
    def append(self, value: Item | _ItemValue): ...
...
class Sequence:
    def __new__(
        cls: type,
        items: abc.Sequence[Item | _ItemValue] | None = None,
        state_member: StateMember | None = None,
    ): ...
