...
class Player(Node):
    '''Plays the given nodes for the given lengths of time, then disposes of them.
    '''
    def __new__(cls: type, sample_rate: int = 48000): ...
    def add(self, node: Node, start: Timestamp, length: Duration) -> None: ...
